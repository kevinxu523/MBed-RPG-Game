...
#define bush    12
#define treeEnt 13
#define treeEntGate 14
#define DoorOpenable 15
#define largeTreeTop 16
#define largeTree   17
#define teleMonster 18
#define game_noKey 19
/**
 ...
 */
void add_plant(int x, int y, int z, int d);
void add_npc(int x , int y, int* state);
void add_cave(int x, int y);
void add_dragon(int x, int y);
void add_iceSpell(int x, int y, int* z);
void add_fireSpell(int x, int y, int* z);
